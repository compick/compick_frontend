                        ...
                        <div className="matchInfo">
                            <div className="team">
                                <div className="container col">
                                    <img src={match.homeLogo} alt={match.home} className="teamLogo" />
                                    <span className="teamName">{match.home}</span>
                                </div>
                            </div>
                            <div className="scoreBox">
                              <span className="scoreText">  {match.homeScore} : {match.awayScore}</span>
                            <div className="matchTime">{match.tiem}</div>
                            </div>
                            <div className="team">
                                <div className="container col">
                                    <img src={match.awayLogo} alt={match.away} className="teamLogo" />
                                    <span className="teamName">{match.away}</span>
                                </div>
                            </div>
                        </div>
                    </div>
