...
export default function HomeBodyPage() {
  ...
  const [activeWidget, setActiveWidget] = useState(null); // 'calendar', 'schedule', or null
  ...
  return (
    <div className="HomeContainer">
      ...
      <div className="widgetContent">
        {activeWidget === "calendar" && <div>📆 캘린더 컴포넌트</div>}
        {activeWidget === "schedule" && <div>🗓️ 경기일정 컴포넌트</div>}
      </div>
    </div>
